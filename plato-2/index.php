    ...
    <div id="container">
        ...
        <nav>
            <ul class="menu"> 
                ...
                <li><a href="index.php?page=inventory"><i class="fa-sharp fa-solid fa-warehouse"></i> Approval of Request</a></li>
                <li><a href="index.php?page=chart"><i class="fa-thin fa-chart-mixed"></i> Maps</a></li>
